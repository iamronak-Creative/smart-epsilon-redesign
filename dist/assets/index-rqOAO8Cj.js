...
`)+`
`+m);const w=y+p+a,M=y+m+o,b=ud(i,i.VERTEX_SHADER,w),A=ud(i,i.FRAGMENT_SHADER,M);i.attachShader(g,b),i.attachShader(g,A),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.hasPositionAttribute===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function E(D){if(r.debug.checkShaderErrors){const L=i.getProgramInfoLog(g)||"",H=i.getShaderInfoLog(b)||"",W=i.getShaderInfoLog(A)||"",F=L.trim(),G=H.trim(),U=W.trim();let $=!0,ee=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if($=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,g,b,A);else{const P=hd(i,b,"vertex"),le=hd(i,A,"fragment");lt("WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
...
}`;class vy{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new _m(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new ki({vertexShader:gy,fragmentShader:xy,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new zi(new io(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class My extends ls{constructor(e,t){super();const n=this;let i=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,d=null,f=null,h=null,_=null;const g=typeof XRWebGLBinding<"u",p=new vy,m={},y=t.getContextAttributes();let w=null,M=null;const b=[],A=[],E=new ft;let v=null;const T=new li;T.viewport=new Ft;const C=new li;C.viewport=new Ft;const D=[T,C],L=new R0;let H=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let ae=b[Z];return ae===void 0&&(ae=new rc,b[Z]=ae),ae.getTargetRaySpace()},this.getControllerGrip=function(Z){let ae=b[Z];return ae===void 0&&(ae=new rc,b[Z]=ae),ae.getGripSpace()},this.getHand=function(Z){let ae=b[Z];return ae===void 0&&(ae=new rc,b[Z]=ae),ae.getHandSpace()};function F(Z){const ae=A.indexOf(Z.inputSource);if(ae===-1)return;const ie=b[ae];ie!==void 0&&(ie.update(Z.inputSource,Z.frame,c||a),ie.dispatchEvent({type:Z.type,data:Z.inputSource}))}function G(){i.removeEventListener("select",F),i.removeEventListener("selectstart",F),i.removeEventListener("selectend",F),i.removeEventListener("squeeze",F),i.removeEventListener("squeezestart",F),i.removeEventListener("squeezeend",F),i.removeEventListener("end",G),i.removeEventListener("inputsourceschange",U);for(let Z=0;Z<b.length;Z++){const ae=A[Z];ae!==null&&(A[Z]=null,b[Z].disconnect(ae))}H=null,W=null,p.reset();for(const Z in m)delete m[Z];e.setRenderTarget(w),h=null,f=null,d=null,i=null,M=null,Oe.stop(),n.isPresenting=!1,e.setPixelRatio(v),e.setSize(E.width,E.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){s=Z,n.isPresenting===!0&&ke("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,n.isPresenting===!0&&ke("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(Z){c=Z},this.getBaseLayer=function(){return f!==null?f:h},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(i,t)),d},this.getFrame=function(){return _},this.getSession=function(){return i},this.setSession=async function(Z){if(i=Z,i!==null){if(w=e.getRenderTarget(),i.addEventListener("select",F),i.addEventListener("selectstart",F),i.addEventListener("selectend",F),i.addEventListener("squeeze",F),i.addEventListener("squeezestart",F),i.addEventListener("squeezeend",F),i.addEventListener("end",G),i.addEventListener("inputsourceschange",U),y.xrCompatible!==!0&&await t.makeXRCompatible(),v=e.getPixelRatio(),e.getSize(E),g&&"createProjectionLayer"in XRWebGLBinding.prototype){let ie=null,we=null,Fe=null;y.depth&&(Fe=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ie=y.stencil?qr:sr,we=y.stencil?Ja:Bi);const Te={colorFormat:t.RGBA8,depthFormat:Fe,scaleFactor:s};d=this.getBinding(),f=d.createProjectionLayer(Te),i.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),M=new Ni(f.textureWidth,f.textureHeight,{format:xi,type:ci,depthTexture:new ta(f.textureWidth,f.textureHeight,we,void 0,void 0,void 0,void 0,void 0,void 0,ie),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const ie={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:s};h=new XRWebGLLayer(i,t,ie),i.updateRenderState({baseLayer:h}),e.setPixelRatio(1),e.setSize(h.framebufferWidth,h.framebufferHeight,!1),M=new Ni(h.framebufferWidth,h.framebufferHeight,{format:xi,type:ci,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await i.requestReferenceSpace(o),Oe.setContext(i),Oe.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function U(Z){for(let ae=0;ae<Z.removed.length;ae++){const ie=Z.removed[ae],we=A.indexOf(ie);we>=0&&(A[we]=null,b[we].disconnect(ie))}for(let ae=0;ae<Z.added.length;ae++){const ie=Z.added[ae];let we=A.indexOf(ie);if(we===-1){for(let Te=0;Te<b.length;Te++)if(Te>=A.length){A.push(ie),we=Te;break}else if(A[Te]===null){A[Te]=ie,we=Te;break}if(we===-1)break}const Fe=b[we];Fe&&Fe.connect(ie)}}const $=new Y,ee=new Y;function P(Z,ae,ie){$.setFromMatrixPosition(ae.matrixWorld),ee.setFromMatrixPosition(ie.matrixWorld);const we=$.distanceTo(ee),Fe=ae.projectionMatrix.elements,Te=ie.projectionMatrix.elements,nt=Fe[14]/(Fe[10]-1),ye=Fe[14]/(Fe[10]+1),Be=(Fe[9]+1)/Fe[5],Ge=(Fe[9]-1)/Fe[5],Ve=(Fe[8]-1)/Fe[0],X=(Te[8]+1)/Te[0],ct=nt*Ve,gt=nt*X,Tt=we/(-Ve+X),We=Tt*-Ve;if(ae.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(We),Z.translateZ(Tt),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Fe[10]===-1)Z.projectionMatrix.copy(ae.projectionMatrix),Z.projectionMatrixInverse.copy(ae.projectionMatrixInverse);else{const dt=nt+Tt,N=ye+Tt,It=ct-We,ze=gt+(we-We),R=Be*ye/N*dt,x=Ge*ye/N*dt;Z.projectionMatrix.makePerspective(It,ze,R,x,dt,N),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function le(Z,ae){ae===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(ae.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(i===null)return;let ae=Z.near,ie=Z.far;p.texture!==null&&(p.depthNear>0&&(ae=p.depthNear),p.depthFar>0&&(ie=p.depthFar)),L.near=C.near=T.near=ae,L.far=C.far=T.far=ie,(H!==L.near||W!==L.far)&&(i.updateRenderState({depthNear:L.near,depthFar:L.far}),H=L.near,W=L.far),L.layers.mask=Z.layers.mask|6,T.layers.mask=L.layers.mask&-5,C.layers.mask=L.layers.mask&-3;const we=Z.parent,Fe=L.cameras;le(L,we);for(let Te=0;Te<Fe.length;Te++)le(Fe[Te],we);Fe.length===2?P(L,T,C):L.projectionMatrix.copy(T.projectionMatrix),ge(Z,L,we)};function ge(Z,ae,ie){ie===null?Z.matrix.copy(ae.matrixWorld):(Z.matrix.copy(ie.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(ae.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(ae.projectionMatrix),Z.projectionMatrixInverse.copy(ae.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=Vu*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return L},this.getFoveation=function(){if(!(f===null&&h===null))return l},this.setFoveation=function(Z){l=Z,f!==null&&(f.fixedFoveation=Z),h!==null&&h.fixedFoveation!==void 0&&(h.fixedFoveation=Z)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(L)},this.getCameraTexture=function(Z){return m[Z]};let qe=null;function He(Z,ae){if(u=ae.getViewerPose(c||a),_=ae,u!==null){const ie=u.views;h!==null&&(e.setRenderTargetFramebuffer(M,h.framebuffer),e.setRenderTarget(M));let we=!1;ie.length!==L.cameras.length&&(L.cameras.length=0,we=!0);for(let ye=0;ye<ie.length;ye++){const Be=ie[ye];let Ge=null;if(h!==null)Ge=h.getViewport(Be);else{const X=d.getViewSubImage(f,Be);Ge=X.viewport,ye===0&&(e.setRenderTargetTextures(M,X.colorTexture,X.depthStencilTexture),e.setRenderTarget(M))}let Ve=D[ye];Ve===void 0&&(Ve=new li,Ve.layers.enable(ye),Ve.viewport=new Ft,D[ye]=Ve),Ve.matrix.fromArray(Be.transform.matrix),Ve.matrix.decompose(Ve.position,Ve.quaternion,Ve.scale),Ve.projectionMatrix.fromArray(Be.projectionMatrix),Ve.projectionMatrixInverse.copy(Ve.projectionMatrix).invert(),Ve.viewport.set(Ge.x,Ge.y,Ge.width,Ge.height),ye===0&&(L.matrix.copy(Ve.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale)),we===!0&&L.cameras.push(Ve)}const Fe=i.enabledFeatures;if(Fe&&Fe.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&g){d=n.getBinding();const ye=d.getDepthInformation(ie[0]);ye&&ye.isValid&&ye.texture&&p.init(ye,i.renderState)}if(Fe&&Fe.includes("camera-access")&&g){e.state.unbindTexture(),d=n.getBinding();for(let ye=0;ye<ie.length;ye++){const Be=ie[ye].camera;if(Be){let Ge=m[Be];Ge||(Ge=new _m,m[Be]=Ge);const Ve=d.getCameraImage(Be);Ge.sourceTexture=Ve}}}}for(let ie=0;ie<b.length;ie++){const we=A[ie],Fe=b[ie];we!==null&&Fe!==void 0&&Fe.update(we,ae,c||a)}qe&&qe(Z,ae),ae.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ae}),_=null}const Oe=new Mm;Oe.setAnimationLoop(He),this.setAnimationLoop=function(Z){qe=Z},this.dispose=function(){}}}const Sy=new Bt,wm=new Ye;wm.set(-1,0,0,0,1,0,0,0,1);function yy(r,e){function t(p,m){p.matrixAutoUpdate===!0&&p.updateMatrix(),m.value.copy(p.matrix)}function n(p,m){m.color.getRGB(p.fogColor.value,gm(r)),m.isFog?(p.fogNear.value=m.near,p.fogFar.value=m.far):m.isFogExp2&&(p.fogDensity.value=m.density)}function i(p,m,y,w,M){m.isNodeMaterial?m.uniformsNeedUpdate=!1:m.isMeshBasicMaterial?s(p,m):m.isMeshLambertMaterial?(s(p,m),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)):m.isMeshToonMaterial?(s(p,m),d(p,m)):m.isMeshPhongMaterial?(s(p,m),u(p,m),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)):m.isMeshStandardMaterial?(s(p,m),f(p,m),m.isMeshPhysicalMaterial&&h(p,m,M)):m.isMeshMatcapMaterial?(s(p,m),_(p,m)):m.isMeshDepthMaterial?s(p,m):m.isMeshDistanceMaterial?(s(p,m),g(p,m)):m.isMeshNormalMaterial?s(p,m):m.isLineBasicMaterial?(a(p,m),m.isLineDashedMaterial&&o(p,m)):m.isPointsMaterial?l(p,m,y,w):m.isSpriteMaterial?c(p,m):m.isShadowMaterial?(p.color.value.copy(m.color),p.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function s(p,m){p.opacity.value=m.opacity,m.color&&p.diffuse.value.copy(m.color),m.emissive&&p.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(p.map.value=m.map,t(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,t(m.alphaMap,p.alphaMapTransform)),m.bumpMap&&(p.bumpMap.value=m.bumpMap,t(m.bumpMap,p.bumpMapTransform),p.bumpScale.value=m.bumpScale,m.side===Bn&&(p.bumpScale.value*=-1)),m.normalMap&&(p.normalMap.value=m.normalMap,t(m.normalMap,p.normalMapTransform),p.normalScale.value.copy(m.normalScale),m.side===Bn&&p.normalScale.value.negate()),m.displacementMap&&(p.displacementMap.value=m.displacementMap,t(m.displacementMap,p.displacementMapTransform),p.displacementScale.value=m.displacementScale,p.displacementBias.value=m.displacementBias),m.emissiveMap&&(p.emissiveMap.value=m.emissiveMap,t(m.emissiveMap,p.emissiveMapTransform)),m.specularMap&&(p.specularMap.value=m.specularMap,t(m.specularMap,p.specularMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest);const y=e.get(m),w=y.envMap,M=y.envMapRotation;w&&(p.envMap.value=w,p.envMapRotation.value.setFromMatrix4(Sy.makeRotationFromEuler(M)).transpose(),w.isCubeTexture&&w.isRenderTargetTexture===!1&&p.envMapRotation.value.premultiply(wm),p.reflectivity.value=m.reflectivity,p.ior.value=m.ior,p.refractionRatio.value=m.refractionRatio),m.lightMap&&(p.lightMap.value=m.lightMap,p.lightMapIntensity.value=m.lightMapIntensity,t(m.lightMap,p.lightMapTransform)),m.aoMap&&(p.aoMap.value=m.aoMap,p.aoMapIntensity.value=m.aoMapIntensity,t(m.aoMap,p.aoMapTransform))}function a(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,m.map&&(p.map.value=m.map,t(m.map,p.mapTransform))}function o(p,m){p.dashSize.value=m.dashSize,p.totalSize.value=m.dashSize+m.gapSize,p.scale.value=m.scale}function l(p,m,y,w){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.size.value=m.size*y,p.scale.value=w*.5,m.map&&(p.map.value=m.map,t(m.map,p.uvTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,t(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function c(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.rotation.value=m.rotation,m.map&&(p.map.value=m.map,t(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,t(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function u(p,m){p.specular.value.copy(m.specular),p.shininess.value=Math.max(m.shininess,1e-4)}function d(p,m){m.gradientMap&&(p.gradientMap.value=m.gradientMap)}function f(p,m){p.metalness.value=m.metalness,m.metalnessMap&&(p.metalnessMap.value=m.metalnessMap,t(m.metalnessMap,p.metalnessMapTransform)),p.roughness.value=m.roughness,m.roughnessMap&&(p.roughnessMap.value=m.roughnessMap,t(m.roughnessMap,p.roughnessMapTransform)),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)}function h(p,m,y){p.ior.value=m.ior,m.sheen>0&&(p.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),p.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(p.sheenColorMap.value=m.sheenColorMap,t(m.sheenColorMap,p.sheenColorMapTransform)),m.sheenRoughnessMap&&(p.sheenRoughnessMap.value=m.sheenRoughnessMap,t(m.sheenRoughnessMap,p.sheenRoughnessMapTransform))),m.clearcoat>0&&(p.clearcoat.value=m.clearcoat,p.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(p.clearcoatMap.value=m.clearcoatMap,t(m.clearcoatMap,p.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,t(m.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(p.clearcoatNormalMap.value=m.clearcoatNormalMap,t(m.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===Bn&&p.clearcoatNormalScale.value.negate())),m.dispersion>0&&(p.dispersion.value=m.dispersion),m.iridescence>0&&(p.iridescence.value=m.iridescence,p.iridescenceIOR.value=m.iridescenceIOR,p.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(p.iridescenceMap.value=m.iridescenceMap,t(m.iridescenceMap,p.iridescenceMapTransform)),m.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=m.iridescenceThicknessMap,t(m.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),m.transmission>0&&(p.transmission.value=m.transmission,p.transmissionSamplerMap.value=y.texture,p.transmissionSamplerSize.value.set(y.width,y.height),m.transmissionMap&&(p.transmissionMap.value=m.transmissionMap,t(m.transmissionMap,p.transmissionMapTransform)),p.thickness.value=m.thickness,m.thicknessMap&&(p.thicknessMap.value=m.thicknessMap,t(m.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=m.attenuationDistance,p.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(p.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(p.anisotropyMap.value=m.anisotropyMap,t(m.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=m.specularIntensity,p.specularColor.value.copy(m.specularColor),m.specularColorMap&&(p.specularColorMap.value=m.specularColorMap,t(m.specularColorMap,p.specularColorMapTransform)),m.specularIntensityMap&&(p.specularIntensityMap.value=m.specularIntensityMap,t(m.specularIntensityMap,p.specularIntensityMapTransform))}function _(p,m){m.matcap&&(p.matcap.value=m.matcap)}function g(p,m){const y=e.get(m).light;p.referencePosition.value.setFromMatrixPosition(y.matrixWorld),p.nearDistance.value=y.shadow.camera.near,p.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function Ey(r,e,t,n){let i={},s={},a=[];const o=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function l(M,b){const A=b.program;n.uniformBlockBinding(M,A)}function c(M,b){let A=i[M.id];A===void 0&&(p(M),A=u(M),i[M.id]=A,M.addEventListener("dispose",y));const E=b.program;n.updateUBOMapping(M,E);const v=e.render.frame;s[M.id]!==v&&(f(M),s[M.id]=v)}function u(M){const b=d();M.__bindingPointIndex=b;const A=r.createBuffer(),E=M.__size,v=M.usage;return r.bindBuffer(r.UNIFORM_BUFFER,A),r.bufferData(r.UNIFORM_BUFFER,E,v),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,b,A),A}function d(){for(let M=0;M<o;M++)if(a.indexOf(M)===-1)return a.push(M),M;return lt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(M){const b=i[M.id],A=M.uniforms,E=M.__cache;r.bindBuffer(r.UNIFORM_BUFFER,b);for(let v=0,T=A.length;v<T;v++){const C=A[v];if(Array.isArray(C))for(let D=0,L=C.length;D<L;D++)h(C[D],v,D,E);else h(C,v,0,E)}r.bindBuffer(r.UNIFORM_BUFFER,null)}function h(M,b,A,E){if(g(M,b,A,E)===!0){const v=M.__offset,T=M.value;if(Array.isArray(T)){let C=0;for(let D=0;D<T.length;D++){const L=T[D],H=m(L);_(L,M.__data,C),typeof L!="number"&&typeof L!="boolean"&&!L.isMatrix3&&!ArrayBuffer.isView(L)&&(C+=H.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(T,M.__data,0);r.bufferSubData(r.UNIFORM_BUFFER,v,M.__data)}}function _(M,b,A){typeof M=="number"||typeof M=="boolean"?b[0]=M:M.isMatrix3?(b[0]=M.elements[0],b[1]=M.elements[1],b[2]=M.elements[2],b[3]=0,b[4]=M.elements[3],b[5]=M.elements[4],b[6]=M.elements[5],b[7]=0,b[8]=M.elements[6],b[9]=M.elements[7],b[10]=M.elements[8],b[11]=0):ArrayBuffer.isView(M)?b.set(new M.constructor(M.buffer,M.byteOffset,b.length)):M.toArray(b,A)}function g(M,b,A,E){const v=M.value,T=b+"_"+A;if(E[T]===void 0)return typeof v=="number"||typeof v=="boolean"?E[T]=v:ArrayBuffer.isView(v)?E[T]=v.slice():E[T]=v.clone(),!0;{const C=E[T];if(typeof v=="number"||typeof v=="boolean"){if(C!==v)return E[T]=v,!0}else{if(ArrayBuffer.isView(v))return!0;if(C.equals(v)===!1)return C.copy(v),!0}}return!1}function p(M){const b=M.uniforms;let A=0;const E=16;for(let T=0,C=b.length;T<C;T++){const D=Array.isArray(b[T])?b[T]:[b[T]];for(let L=0,H=D.length;L<H;L++){const W=D[L],F=Array.isArray(W.value)?W.value:[W.value];for(let G=0,U=F.length;G<U;G++){const $=F[G],ee=m($),P=A%E,le=P%ee.boundary,ge=P+le;A+=le,ge!==0&&E-ge<ee.storage&&(A+=E-ge),W.__data=new Float32Array(ee.storage/Float32Array.BYTES_PER_ELEMENT),W.__offset=A,A+=ee.storage}}}const v=A%E;return v>0&&(A+=E-v),M.__size=A,M.__cache={},this}function m(M){const b={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(b.boundary=4,b.storage=4):M.isVector2?(b.boundary=8,b.storage=8):M.isVector3||M.isColor?(b.boundary=16,b.storage=12):M.isVector4?(b.boundary=16,b.storage=16):M.isMatrix3?(b.boundary=48,b.storage=48):M.isMatrix4?(b.boundary=64,b.storage=64):M.isTexture?ke("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(b.boundary=16,b.storage=M.byteLength):ke("WebGLRenderer: Unsupported uniform value type.",M),b}function y(M){const b=M.target;b.removeEventListener("dispose",y);const A=a.indexOf(b.__bindingPointIndex);a.splice(A,1),r.deleteBuffer(i[b.id]),delete i[b.id],delete s[b.id]}function w(){for(const M in i)r.deleteBuffer(i[M]);a=[],i={},s={}}return{bind:l,update:c,dispose:w}}const Ty=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Ti=null;function by(){return Ti===null&&(Ti=new p0(Ty,16,16,ss,rr),Ti.name="DFG_LUT",Ti.minFilter=xn,Ti.magFilter=xn,Ti.wrapS=Qi,Ti.wrapT=Qi,Ti.generateMipmaps=!1,Ti.needsUpdate=!0),Ti}class Ay{constructor(e={}){const{canvas:t=Xg(),context:n=null,depth:i=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:f=!1,outputBufferType:h=ci}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const g=h,p=new Set([bf,Tf,Ef]),m=new Set([ci,Bi,Za,Ja,Sf,yf]),y=new Uint32Array(4),w=new Int32Array(4),M=new Y;let b=null,A=null;const E=[],v=[];let T=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ui,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const C=this;let D=!1,L=null,H=null,W=null,F=null;this._outputColorSpace=si;let G=0,U=0,$=null,ee=-1,P=null;const le=new Ft,ge=new Ft;let qe=null;const He=new ht(0);let Oe=0,Z=t.width,ae=t.height,ie=1,we=null,Fe=null;const Te=new Ft(0,0,Z,ae),nt=new Ft(0,0,Z,ae);let ye=!1;const Be=new dm;let Ge=!1,Ve=!1;const X=new Bt,ct=new Y,gt=new Ft,Tt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let We=!1;function dt(){return $===null?ie:1}let N=n;function It(S,O){return t.getContext(S,O)}try{const S={alpha:!0,depth:i,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${vf}`),t.addEventListener("webglcontextlost",Ue,!1),t.addEventListener("webglcontextrestored",se,!1),t.addEventListener("webglcontextcreationerror",Ne,!1),N===null){const O="webgl2";if(N=It(O,S),N===null)throw It(O)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(S){throw lt("WebGLRenderer: "+S.message),S}let ze,R,x,B,k,K,ue,oe,J,Q,de,Ae,pe,he,ce,Pe,Ie,I,fe,j,me,_e,te;function re(){ze=new bM(N),ze.init(),me=new _y(N,ze),R=new gM(N,ze,e,me),x=new py(N,ze),R.reversedDepthBuffer&&f&&x.buffers.depth.setReversed(!0),H=N.createFramebuffer(),W=N.createFramebuffer(),F=N.createFramebuffer(),B=new RM(N),k=new ey,K=new my(N,ze,x,k,R,me,B),ue=new TM(C),oe=new L0(N),_e=new mM(N,oe),J=new AM(N,oe,B,_e),Q=new PM(N,J,oe,_e,B),I=new CM(N,R,K),ce=new xM(k),de=new jS(C,ue,ze,R,_e,ce),Ae=new yy(C,k),pe=new ny,he=new ly(ze),Ie=new pM(C,ue,x,Q,_,l),Pe=new dy(C,Q,R),te=new Ey(N,B,R,x),fe=new _M(N,ze,B),j=new wM(N,ze,B),B.programs=de.programs,C.capabilities=R,C.extensions=ze,C.properties=k,C.renderLists=pe,C.shadowMap=Pe,C.state=x,C.info=B}re(),g!==ci&&(T=new LM(g,t.width,t.height,o,i,s));const ne=new My(C,N);this.xr=ne,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){const S=ze.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=ze.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return ie},this.setPixelRatio=function(S){S!==void 0&&(ie=S,this.setSize(Z,ae,!1))},this.getSize=function(S){return S.set(Z,ae)},this.setSize=function(S,O,q=!0){if(ne.isPresenting){ke("WebGLRenderer: Can't change size while VR device is presenting.");return}Z=S,ae=O,t.width=Math.floor(S*ie),t.height=Math.floor(O*ie),q===!0&&(t.style.width=S+"px",t.style.height=O+"px"),T!==null&&T.setSize(t.width,t.height),this.setViewport(0,0,S,O)},this.getDrawingBufferSize=function(S){return S.set(Z*ie,ae*ie).floor()},this.setDrawingBufferSize=function(S,O,q){Z=S,ae=O,ie=q,t.width=Math.floor(S*q),t.height=Math.floor(O*q),this.setViewport(0,0,S,O)},this.setEffects=function(S){if(g===ci){lt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let O=0;O<S.length;O++)if(S[O].isOutputPass===!0){ke("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}T.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(le)},this.getViewport=function(S){return S.copy(Te)},this.setViewport=function(S,O,q,z){S.isVector4?Te.set(S.x,S.y,S.z,S.w):Te.set(S,O,q,z),x.viewport(le.copy(Te).multiplyScalar(ie).round())},this.getScissor=function(S){return S.copy(nt)},this.setScissor=function(S,O,q,z){S.isVector4?nt.set(S.x,S.y,S.z,S.w):nt.set(S,O,q,z),x.scissor(ge.copy(nt).multiplyScalar(ie).round())},this.getScissorTest=function(){return ye},this.setScissorTest=function(S){x.setScissorTest(ye=S)},this.setOpaqueSort=function(S){we=S},this.setTransparentSort=function(S){Fe=S},this.getClearColor=function(S){return S.copy(Ie.getClearColor())},this.setClearColor=function(){Ie.setClearColor(...arguments)},this.getClearAlpha=function(){return Ie.getClearAlpha()},this.setClearAlpha=function(){Ie.setClearAlpha(...arguments)},this.clear=function(S=!0,O=!0,q=!0){let z=0;if(S){let V=!1;if($!==null){const xe=$.texture.format;V=p.has(xe)}if(V){const xe=$.texture.type,ve=m.has(xe),Se=Ie.getClearColor(),Ce=Ie.getClearAlpha(),De=Se.r,$e=Se.g,Ze=Se.b;ve?(y[0]=De,y[1]=$e,y[2]=Ze,y[3]=Ce,N.clearBufferuiv(N.COLOR,0,y)):(w[0]=De,w[1]=$e,w[2]=Ze,w[3]=Ce,N.clearBufferiv(N.COLOR,0,w))}else z|=N.COLOR_BUFFER_BIT}O&&(z|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),q&&(z|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),z!==0&&N.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(S){S.setRenderer(this),L=S},this.dispose=function(){t.removeEventListener("webglcontextlost",Ue,!1),t.removeEventListener("webglcontextrestored",se,!1),t.removeEventListener("webglcontextcreationerror",Ne,!1),Ie.dispose(),pe.dispose(),he.dispose(),k.dispose(),ue.dispose(),Q.dispose(),_e.dispose(),te.dispose(),de.dispose(),ne.dispose(),ne.removeEventListener("sessionstart",Rt),ne.removeEventListener("sessionend",vt),rt.stop()};function Ue(S){S.preventDefault(),Rh("WebGLRenderer: Context Lost."),D=!0}function se(){Rh("WebGLRenderer: Context Restored."),D=!1;const S=B.autoReset,O=Pe.enabled,q=Pe.autoUpdate,z=Pe.needsUpdate,V=Pe.type;re(),B.autoReset=S,Pe.enabled=O,Pe.autoUpdate=q,Pe.needsUpdate=z,Pe.type=V}function Ne(S){lt("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function Re(S){const O=S.target;O.removeEventListener("dispose",Re),Xe(O)}function Xe(S){Wt(S),k.remove(S)}function Wt(S){const O=k.get(S).programs;O!==void 0&&(O.forEach(function(q){de.releaseProgram(q)}),S.isShaderMaterial&&de.releaseShaderCache(S))}this.renderBufferDirect=function(S,O,q,z,V,xe){O===null&&(O=Tt);const ve=V.isMesh&&V.matrixWorld.determinantAffine()<0,Se=tn(S,O,q,z,V);x.setMaterial(z,ve);let Ce=q.index,De=1;if(z.wireframe===!0){if(Ce=J.getWireframeAttribute(q),Ce===void 0)return;De=2}const $e=q.drawRange,Ze=q.attributes.position;let Le=$e.start*De,xt=($e.start+$e.count)*De;xe!==null&&(Le=Math.max(Le,xe.start*De),xt=Math.min(xt,(xe.start+xe.count)*De)),Ce!==null?(Le=Math.max(Le,0),xt=Math.min(xt,Ce.count)):Ze!=null&&(Le=Math.max(Le,0),xt=Math.min(xt,Ze.count));const kt=xt-Le;if(kt<0||kt===1/0)return;_e.setup(V,z,Se,q,Ce);let Nt,Mt=fe;if(Ce!==null&&(Nt=oe.get(Ce),Mt=j,Mt.setIndex(Nt)),V.isMesh)z.wireframe===!0?(x.setLineWidth(z.wireframeLinewidth*dt()),Mt.setMode(N.LINES)):Mt.setMode(N.TRIANGLES);else if(V.isLine){let fn=z.linewidth;fn===void 0&&(fn=1),x.setLineWidth(fn*dt()),V.isLineSegments?Mt.setMode(N.LINES):V.isLineLoop?Mt.setMode(N.LINE_LOOP):Mt.setMode(N.LINE_STRIP)}else V.isPoints?Mt.setMode(N.POINTS):V.isSprite&&Mt.setMode(N.TRIANGLES);if(V.isBatchedMesh)if(ze.get("WEBGL_multi_draw"))Mt.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{const fn=V._multiDrawStarts,Ee=V._multiDrawCounts,Vn=V._multiDrawCount,ut=Ce?oe.get(Ce).bytesPerElement:1,ni=k.get(z).currentProgram.getUniforms();for(let yi=0;yi<Vn;yi++)ni.setValue(N,"_gl_DrawID",yi),Mt.render(fn[yi]/ut,Ee[yi])}else if(V.isInstancedMesh)Mt.renderInstances(Le,kt,V.count);else if(q.isInstancedBufferGeometry){const fn=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,Ee=Math.min(q.instanceCount,fn);Mt.renderInstances(Le,kt,Ee)}else Mt.render(Le,kt)};function Qe(S,O,q){S.transparent===!0&&S.side===Zi&&S.forceSinglePass===!1?(S.side=Bn,S.needsUpdate=!0,Ut(S,O,q),S.side=Pr,S.needsUpdate=!0,Ut(S,O,q),S.side=Zi):Ut(S,O,q)}this.compile=function(S,O,q=null){q===null&&(q=S),A=he.get(q),A.init(O),v.push(A),q.traverseVisible(function(V){V.isLight&&V.layers.test(O.layers)&&(A.pushLight(V),V.castShadow&&A.pushShadow(V))}),S!==q&&S.traverseVisible(function(V){V.isLight&&V.layers.test(O.layers)&&(A.pushLight(V),V.castShadow&&A.pushShadow(V))}),A.setupLights();const z=new Set;return S.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;const xe=V.material;if(xe)if(Array.isArray(xe))for(let ve=0;ve<xe.length;ve++){const Se=xe[ve];Qe(Se,q,V),z.add(Se)}else Qe(xe,q,V),z.add(xe)}),A=v.pop(),z},this.compileAsync=function(S,O,q=null){const z=this.compile(S,O,q);return new Promise(V=>{function xe(){if(z.forEach(function(ve){k.get(ve).currentProgram.isReady()&&z.delete(ve)}),z.size===0){V(S);return}setTimeout(xe,10)}ze.get("KHR_parallel_shader_compile")!==null?xe():setTimeout(xe,10)})};let wt=null;function en(S){wt&&wt(S)}function Rt(){rt.stop()}function vt(){rt.start()}const rt=new Mm;rt.setAnimationLoop(en),typeof self<"u"&&rt.setContext(self),this.setAnimationLoop=function(S){wt=S,ne.setAnimationLoop(S),S===null?rt.stop():rt.start()},ne.addEventListener("sessionstart",Rt),ne.addEventListener("sessionend",vt),this.render=function(S,O){if(O!==void 0&&O.isCamera!==!0){lt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;L!==null&&L.renderStart(S,O);const q=ne.enabled===!0&&ne.isPresenting===!0,z=T!==null&&($===null||q)&&T.begin(C,$);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),ne.enabled===!0&&ne.isPresenting===!0&&(T===null||T.isCompositing()===!1)&&(ne.cameraAutoUpdate===!0&&ne.updateCamera(O),O=ne.getCamera()),S.isScene===!0&&S.onBeforeRender(C,S,O,$),A=he.get(S,v.length),A.init(O),A.state.textureUnits=K.getTextureUnits(),v.push(A),X.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),Be.setFromProjectionMatrix(X,Li,O.reversedDepth),Ve=this.localClippingEnabled,Ge=ce.init(this.clippingPlanes,Ve),b=pe.get(S,E.length),b.init(),E.push(b),ne.enabled===!0&&ne.isPresenting===!0){const ve=C.xr.getDepthSensingMesh();ve!==null&&Mn(ve,O,-1/0,C.sortObjects)}Mn(S,O,0,C.sortObjects),b.finish(),C.sortObjects===!0&&b.sort(we,Fe,O.reversedDepth),We=ne.enabled===!1||ne.isPresenting===!1||ne.hasDepthSensing()===!1,We&&Ie.addToRenderList(b,S),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Ge===!0&&ce.beginShadows();const V=A.state.shadowsArray;if(Pe.render(V,S,O),Ge===!0&&ce.endShadows(),(z&&T.hasRenderPass())===!1){const ve=b.opaque,Se=b.transmissive;if(A.setupLights(),O.isArrayCamera){const Ce=O.cameras;if(Se.length>0)for(let De=0,$e=Ce.length;De<$e;De++){const Ze=Ce[De];un(ve,Se,S,Ze)}We&&Ie.render(S);for(let De=0,$e=Ce.length;De<$e;De++){const Ze=Ce[De];bt(b,S,Ze,Ze.viewport)}}else Se.length>0&&un(ve,Se,S,O),We&&Ie.render(S),bt(b,S,O)}$!==null&&U===0&&(K.updateMultisampleRenderTarget($),K.updateRenderTargetMipmap($)),z&&T.end(C),S.isScene===!0&&S.onAfterRender(C,S,O),_e.resetDefaultState(),ee=-1,P=null,v.pop(),v.length>0?(A=v[v.length-1],K.setTextureUnits(A.state.textureUnits),Ge===!0&&ce.setGlobalState(C.clippingPlanes,A.state.camera)):A=null,E.pop(),E.length>0?b=E[E.length-1]:b=null,L!==null&&L.renderEnd()};function Mn(S,O,q,z){if(S.visible===!1)return;if(S.layers.test(O.layers)){if(S.isGroup)q=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(O);else if(S.isLightProbeGrid)A.pushLightProbeGrid(S);else if(S.isLight)A.pushLight(S),S.castShadow&&A.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||Be.intersectsSprite(S)){z&&gt.setFromMatrixPosition(S.matrixWorld).applyMatrix4(X);const ve=Q.update(S),Se=S.material;Se.visible&&b.push(S,ve,Se,q,gt.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||Be.intersectsObject(S))){const ve=Q.update(S),Se=S.material;if(z&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),gt.copy(S.boundingSphere.center)):(ve.boundingSphere===null&&ve.computeBoundingSphere(),gt.copy(ve.boundingSphere.center)),gt.applyMatrix4(S.matrixWorld).applyMatrix4(X)),Array.isArray(Se)){const Ce=ve.groups;for(let De=0,$e=Ce.length;De<$e;De++){const Ze=Ce[De],Le=Se[Ze.materialIndex];Le&&Le.visible&&b.push(S,ve,Le,q,gt.z,Ze)}}else Se.visible&&b.push(S,ve,Se,q,gt.z,null)}}const xe=S.children;for(let ve=0,Se=xe.length;ve<Se;ve++)Mn(xe[ve],O,q,z)}function bt(S,O,q,z){const{opaque:V,transmissive:xe,transparent:ve}=S;A.setupLightsView(q),Ge===!0&&ce.setGlobalState(C.clippingPlanes,q),z&&x.viewport(le.copy(z)),V.length>0&&Sn(V,O,q),xe.length>0&&Sn(xe,O,q),ve.length>0&&Sn(ve,O,q),x.buffers.depth.setTest(!0),x.buffers.depth.setMask(!0),x.buffers.color.setMask(!0),x.setPolygonOffset(!1)}function un(S,O,q,z){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[z.id]===void 0){const Le=ze.has("EXT_color_buffer_half_float")||ze.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[z.id]=new Ni(1,1,{generateMipmaps:!0,type:Le?rr:ci,minFilter:Yr,samples:Math.max(4,R.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:st.workingColorSpace})}const xe=A.state.transmissionRenderTarget[z.id],ve=z.viewport||le;xe.setSize(ve.z*C.transmissionResolutionScale,ve.w*C.transmissionResolutionScale);const Se=C.getRenderTarget(),Ce=C.getActiveCubeFace(),De=C.getActiveMipmapLevel();C.setRenderTarget(xe),C.getClearColor(He),Oe=C.getClearAlpha(),Oe<1&&C.setClearColor(16777215,.5),C.clear(),We&&Ie.render(q);const $e=C.toneMapping;C.toneMapping=Ui;const Ze=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),A.setupLightsView(z),Ge===!0&&ce.setGlobalState(C.clippingPlanes,z),Sn(S,q,z),K.updateMultisampleRenderTarget(xe),K.updateRenderTargetMipmap(xe),ze.has("WEBGL_multisampled_render_to_texture")===!1){let Le=!1;for(let xt=0,kt=O.length;xt<kt;xt++){const Nt=O[xt],{object:Mt,geometry:fn,material:Ee,group:Vn}=Nt;if(Ee.side===Zi&&Mt.layers.test(z.layers)){const ut=Ee.side;Ee.side=Bn,Ee.needsUpdate=!0,Xt(Mt,q,z,fn,Ee,Vn),Ee.side=ut,Ee.needsUpdate=!0,Le=!0}}Le===!0&&(K.updateMultisampleRenderTarget(xe),K.updateRenderTargetMipmap(xe))}C.setRenderTarget(Se,Ce,De),C.setClearColor(He,Oe),Ze!==void 0&&(z.viewport=Ze),C.toneMapping=$e}function Sn(S,O,q){const z=O.isScene===!0?O.overrideMaterial:null;for(let V=0,xe=S.length;V<xe;V++){const ve=S[V],{object:Se,geometry:Ce,group:De}=ve;let $e=ve.material;$e.allowOverride===!0&&z!==null&&($e=z),Se.layers.test(q.layers)&&Xt(Se,O,q,Ce,$e,De)}}function Xt(S,O,q,z,V,xe){S.onBeforeRender(C,O,q,z,V,xe),S.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),V.onBeforeRender(C,O,q,z,S,xe),V.transparent===!0&&V.side===Zi&&V.forceSinglePass===!1?(V.side=Bn,V.needsUpdate=!0,C.renderBufferDirect(q,O,z,V,S,xe),V.side=Pr,V.needsUpdate=!0,C.renderBufferDirect(q,O,z,V,S,xe),V.side=Zi):C.renderBufferDirect(q,O,z,V,S,xe),S.onAfterRender(C,O,q,z,V,xe)}function Ut(S,O,q){O.isScene!==!0&&(O=Tt);const z=k.get(S),V=A.state.lights,xe=A.state.shadowsArray,ve=V.state.version,Se=de.getParameters(S,V.state,xe,O,q,A.state.lightProbeGridArray),Ce=de.getProgramCacheKey(Se);let De=z.programs;z.environment=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?O.environment:null,z.fog=O.fog;const $e=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap;z.envMap=ue.get(S.envMap||z.environment,$e),z.envMapRotation=z.environment!==null&&S.envMap===null?O.environmentRotation:S.envMapRotation,De===void 0&&(S.addEventListener("dispose",Re),De=new Map,z.programs=De);let Ze=De.get(Ce);if(Ze!==void 0){if(z.currentProgram===Ze&&z.lightsStateVersion===ve)return Si(S,Se),Ze}else Se.uniforms=de.getUniforms(S),L!==null&&S.isNodeMaterial&&L.build(S,q,Se),S.onBeforeCompile(Se,C),Ze=de.acquireProgram(Se,Ce),De.set(Ce,Ze),z.uniforms=Se.uniforms;const Le=z.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Le.clippingPlanes=ce.uniform),Si(S,Se),z.needsLights=ti(S),z.lightsStateVersion=ve,z.needsLights&&(Le.ambientLightColor.value=V.state.ambient,Le.lightProbe.value=V.state.probe,Le.directionalLights.value=V.state.directional,Le.directionalLightShadows.value=V.state.directionalShadow,Le.spotLights.value=V.state.spot,Le.spotLightShadows.value=V.state.spotShadow,Le.rectAreaLights.value=V.state.rectArea,Le.ltc_1.value=V.state.rectAreaLTC1,Le.ltc_2.value=V.state.rectAreaLTC2,Le.pointLights.value=V.state.point,Le.pointLightShadows.value=V.state.pointShadow,Le.hemisphereLights.value=V.state.hemi,Le.directionalShadowMatrix.value=V.state.directionalShadowMatrix,Le.spotLightMatrix.value=V.state.spotLightMatrix,Le.spotLightMap.value=V.state.spotLightMap,Le.pointShadowMatrix.value=V.state.pointShadowMatrix),z.lightProbeGrid=A.state.lightProbeGridArray.length>0,z.currentProgram=Ze,z.uniformsList=null,Ze}function Kt(S){if(S.uniformsList===null){const O=S.currentProgram.getUniforms();S.uniformsList=ol.seqWithValue(O.seq,S.uniforms)}return S.uniformsList}function Si(S,O){const q=k.get(S);q.outputColorSpace=O.outputColorSpace,q.batching=O.batching,q.batchingColor=O.batchingColor,q.instancing=O.instancing,q.instancingColor=O.instancingColor,q.instancingMorph=O.instancingMorph,q.skinning=O.skinning,q.morphTargets=O.morphTargets,q.morphNormals=O.morphNormals,q.morphColors=O.morphColors,q.morphTargetsCount=O.morphTargetsCount,q.numClippingPlanes=O.numClippingPlanes,q.numIntersection=O.numClipIntersection,q.vertexAlphas=O.vertexAlphas,q.vertexTangents=O.vertexTangents,q.toneMapping=O.toneMapping}function cs(S,O){if(S.length===0)return null;if(S.length===1)return S[0].texture!==null?S[0]:null;M.setFromMatrixPosition(O.matrixWorld);for(let q=0,z=S.length;q<z;q++){const V=S[q];if(V.texture!==null&&V.boundingBox.containsPoint(M))return V}return null}function tn(S,O,q,z,V){O.isScene!==!0&&(O=Tt),K.resetTextureUnits();const xe=O.fog,ve=z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial?O.environment:null,Se=$===null?C.outputColorSpace:$.isXRRenderTarget===!0?$.texture.colorSpace:st.workingColorSpace,Ce=z.isMeshStandardMaterial||z.isMeshLambertMaterial&&!z.envMap||z.isMeshPhongMaterial&&!z.envMap,De=ue.get(z.envMap||ve,Ce),$e=z.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,Ze=!!q.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),Le=!!q.morphAttributes.position,xt=!!q.morphAttributes.normal,kt=!!q.morphAttributes.color;let Nt=Ui;z.toneMapped&&($===null||$.isXRRenderTarget===!0)&&(Nt=C.toneMapping);const Mt=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,fn=Mt!==void 0?Mt.length:0,Ee=k.get(z),Vn=A.state.lights;if(Ge===!0&&(Ve===!0||S!==P)){const At=S===P&&z.id===ee;ce.setState(z,S,At)}let ut=!1;z.version===Ee.__version?(Ee.needsLights&&Ee.lightsStateVersion!==Vn.state.version||Ee.outputColorSpace!==Se||V.isBatchedMesh&&Ee.batching===!1||!V.isBatchedMesh&&Ee.batching===!0||V.isBatchedMesh&&Ee.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&Ee.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&Ee.instancing===!1||!V.isInstancedMesh&&Ee.instancing===!0||V.isSkinnedMesh&&Ee.skinning===!1||!V.isSkinnedMesh&&Ee.skinning===!0||V.isInstancedMesh&&Ee.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&Ee.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&Ee.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&Ee.instancingMorph===!1&&V.morphTexture!==null||Ee.envMap!==De||z.fog===!0&&Ee.fog!==xe||Ee.numClippingPlanes!==void 0&&(Ee.numClippingPlanes!==ce.numPlanes||Ee.numIntersection!==ce.numIntersection)||Ee.vertexAlphas!==$e||Ee.vertexTangents!==Ze||Ee.morphTargets!==Le||Ee.morphNormals!==xt||Ee.morphColors!==kt||Ee.toneMapping!==Nt||Ee.morphTargetsCount!==fn||!!Ee.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(ut=!0):(ut=!0,Ee.__version=z.version);let ni=Ee.currentProgram;ut===!0&&(ni=Ut(z,O,V),L&&z.isNodeMaterial&&L.onUpdateProgram(z,ni,Ee));let yi=!1,ar=!1,us=!1;const St=ni.getUniforms(),Vt=Ee.uniforms;if(x.useProgram(ni.program)&&(yi=!0,ar=!0,us=!0),z.id!==ee&&(ee=z.id,ar=!0),Ee.needsLights){const At=cs(A.state.lightProbeGridArray,V);Ee.lightProbeGrid!==At&&(Ee.lightProbeGrid=At,ar=!0)}if(yi||P!==S){x.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),St.setValue(N,"projectionMatrix",S.projectionMatrix),St.setValue(N,"viewMatrix",S.matrixWorldInverse);const lr=St.map.cameraPosition;lr!==void 0&&lr.setValue(N,ct.setFromMatrixPosition(S.matrixWorld)),R.logarithmicDepthBuffer&&St.setValue(N,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&St.setValue(N,"isOrthographic",S.isOrthographicCamera===!0),P!==S&&(P=S,ar=!0,us=!0)}if(Ee.needsLights&&(Vn.state.directionalShadowMap.length>0&&St.setValue(N,"directionalShadowMap",Vn.state.directionalShadowMap,K),Vn.state.spotShadowMap.length>0&&St.setValue(N,"spotShadowMap",Vn.state.spotShadowMap,K),Vn.state.pointShadowMap.length>0&&St.setValue(N,"pointShadowMap",Vn.state.pointShadowMap,K)),V.isSkinnedMesh){St.setOptional(N,V,"bindMatrix"),St.setOptional(N,V,"bindMatrixInverse");const At=V.skeleton;At&&(At.boneTexture===null&&At.computeBoneTexture(),St.setValue(N,"boneTexture",At.boneTexture,K))}V.isBatchedMesh&&(St.setOptional(N,V,"batchingTexture"),St.setValue(N,"batchingTexture",V._matricesTexture,K),St.setOptional(N,V,"batchingIdTexture"),St.setValue(N,"batchingIdTexture",V._indirectTexture,K),St.setOptional(N,V,"batchingColorTexture"),V._colorsTexture!==null&&St.setValue(N,"batchingColorTexture",V._colorsTexture,K));const or=q.morphAttributes;if((or.position!==void 0||or.normal!==void 0||or.color!==void 0)&&I.update(V,q,ni),(ar||Ee.receiveShadow!==V.receiveShadow)&&(Ee.receiveShadow=V.receiveShadow,St.setValue(N,"receiveShadow",V.receiveShadow)),(z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial)&&z.envMap===null&&O.environment!==null&&(Vt.envMapIntensity.value=O.environmentIntensity),Vt.dfgLUT!==void 0&&(Vt.dfgLUT.value=by()),ar){if(St.setValue(N,"toneMappingExposure",C.toneMappingExposure),Ee.needsLights&&zt(Vt,us),xe&&z.fog===!0&&Ae.refreshFogUniforms(Vt,xe),Ae.refreshMaterialUniforms(Vt,z,ie,ae,A.state.transmissionRenderTarget[S.id]),Ee.needsLights&&Ee.lightProbeGrid){const At=Ee.lightProbeGrid;Vt.probesSH.value=At.texture,Vt.probesMin.value.copy(At.boundingBox.min),Vt.probesMax.value.copy(At.boundingBox.max),Vt.probesResolution.value.copy(At.resolution)}ol.upload(N,Kt(Ee),Vt,K)}if(z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(ol.upload(N,Kt(Ee),Vt,K),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&St.setValue(N,"center",V.center),St.setValue(N,"modelViewMatrix",V.modelViewMatrix),St.setValue(N,"normalMatrix",V.normalMatrix),St.setValue(N,"modelMatrix",V.matrixWorld),z.uniformsGroups!==void 0){const At=z.uniformsGroups;for(let lr=0,fs=At.length;lr<fs;lr++){const Of=At[lr];te.update(Of,ni),te.bind(Of,ni)}}return ni}function zt(S,O){S.ambientLightColor.needsUpdate=O,S.lightProbe.needsUpdate=O,S.directionalLights.needsUpdate=O,S.directionalLightShadows.needsUpdate=O,S.pointLights.needsUpdate=O,S.pointLightShadows.needsUpdate=O,S.spotLights.needsUpdate=O,S.spotLightShadows.needsUpdate=O,S.rectAreaLights.needsUpdate=O,S.hemisphereLights.needsUpdate=O}function ti(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return G},this.getActiveMipmapLevel=function(){return U},this.getRenderTarget=function(){return $},this.setRenderTargetTextures=function(S,O,q){const z=k.get(S);z.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,z.__autoAllocateDepthBuffer===!1&&(z.__useRenderToTexture=!1),k.get(S.texture).__webglTexture=O,k.get(S.depthTexture).__webglTexture=z.__autoAllocateDepthBuffer?void 0:q,z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,O){const q=k.get(S);q.__webglFramebuffer=O,q.__useDefaultFramebuffer=O===void 0},this.setRenderTarget=function(S,O=0,q=0){$=S,G=O,U=q;let z=null,V=!1,xe=!1;if(S){const Se=k.get(S);if(Se.__useDefaultFramebuffer!==void 0){x.bindFramebuffer(N.FRAMEBUFFER,Se.__webglFramebuffer),le.copy(S.viewport),ge.copy(S.scissor),qe=S.scissorTest,x.viewport(le),x.scissor(ge),x.setScissorTest(qe),ee=-1;return}else if(Se.__webglFramebuffer===void 0)K.setupRenderTarget(S);else if(Se.__hasExternalTextures)K.rebindTextures(S,k.get(S.texture).__webglTexture,k.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const $e=S.depthTexture;if(Se.__boundDepthTexture!==$e){if($e!==null&&k.has($e)&&(S.width!==$e.image.width||S.height!==$e.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");K.setupDepthRenderbuffer(S)}}const Ce=S.texture;(Ce.isData3DTexture||Ce.isDataArrayTexture||Ce.isCompressedArrayTexture)&&(xe=!0);const De=k.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(De[O])?z=De[O][q]:z=De[O],V=!0):S.samples>0&&K.useMultisampledRTT(S)===!1?z=k.get(S).__webglMultisampledFramebuffer:Array.isArray(De)?z=De[q]:z=De,le.copy(S.viewport),ge.copy(S.scissor),qe=S.scissorTest}else le.copy(Te).multiplyScalar(ie).floor(),ge.copy(nt).multiplyScalar(ie).floor(),qe=ye;if(q!==0&&(z=H),x.bindFramebuffer(N.FRAMEBUFFER,z)&&x.drawBuffers(S,z),x.viewport(le),x.scissor(ge),x.setScissorTest(qe),V){const Se=k.get(S.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+O,Se.__webglTexture,q)}else if(xe){const Se=O;for(let Ce=0;Ce<S.textures.length;Ce++){const De=k.get(S.textures[Ce]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+Ce,De.__webglTexture,q,Se)}}else if(S!==null&&q!==0){const Se=k.get(S.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,Se.__webglTexture,q)}ee=-1},this.readRenderTargetPixels=function(S,O,q,z,V,xe,ve,Se=0){if(!(S&&S.isWebGLRenderTarget)){lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ce=k.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&ve!==void 0&&(Ce=Ce[ve]),Ce){x.bindFramebuffer(N.FRAMEBUFFER,Ce);try{const De=S.textures[Se],$e=De.format,Ze=De.type;if(S.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+Se),!R.textureFormatReadable($e)){lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!R.textureTypeReadable(Ze)){lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=S.width-z&&q>=0&&q<=S.height-V&&N.readPixels(O,q,z,V,me.convert($e),me.convert(Ze),xe)}finally{const De=$!==null?k.get($).__webglFramebuffer:null;x.bindFramebuffer(N.FRAMEBUFFER,De)}}},this.readRenderTargetPixelsAsync=async function(S,O,q,z,V,xe,ve,Se=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ce=k.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&ve!==void 0&&(Ce=Ce[ve]),Ce)if(O>=0&&O<=S.width-z&&q>=0&&q<=S.height-V){x.bindFramebuffer(N.FRAMEBUFFER,Ce);const De=S.textures[Se],$e=De.format,Ze=De.type;if(S.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+Se),!R.textureFormatReadable($e))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!R.textureTypeReadable(Ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Le=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,Le),N.bufferData(N.PIXEL_PACK_BUFFER,xe.byteLength,N.STREAM_READ),N.readPixels(O,q,z,V,me.convert($e),me.convert(Ze),0);const xt=$!==null?k.get($).__webglFramebuffer:null;x.bindFramebuffer(N.FRAMEBUFFER,xt);const kt=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await Yg(N,kt,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,Le),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,xe),N.deleteBuffer(Le),N.deleteSync(kt),xe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,O=null,q=0){const z=Math.pow(2,-q),V=Math.floor(S.image.width*z),xe=Math.floor(S.image.height*z),ve=O!==null?O.x:0,Se=O!==null?O.y:0;K.setTexture2D(S,0),N.copyTexSubImage2D(N.TEXTURE_2D,q,0,0,ve,Se,V,xe),x.unbindTexture()},this.copyTextureToTexture=function(S,O,q=null,z=null,V=0,xe=0){let ve,Se,Ce,De,$e,Ze,Le,xt,kt;const Nt=S.isCompressedTexture?S.mipmaps[xe]:S.image;if(q!==null)ve=q.max.x-q.min.x,Se=q.max.y-q.min.y,Ce=q.isBox3?q.max.z-q.min.z:1,De=q.min.x,$e=q.min.y,Ze=q.isBox3?q.min.z:0;else{const Vt=Math.pow(2,-V);ve=Math.floor(Nt.width*Vt),Se=Math.floor(Nt.height*Vt),S.isDataArrayTexture?Ce=Nt.depth:S.isData3DTexture?Ce=Math.floor(Nt.depth*Vt):Ce=1,De=0,$e=0,Ze=0}z!==null?(Le=z.x,xt=z.y,kt=z.z):(Le=0,xt=0,kt=0);const Mt=me.convert(O.format),fn=me.convert(O.type);let Ee;O.isData3DTexture?(K.setTexture3D(O,0),Ee=N.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(K.setTexture2DArray(O,0),Ee=N.TEXTURE_2D_ARRAY):(K.setTexture2D(O,0),Ee=N.TEXTURE_2D),x.activeTexture(N.TEXTURE0),x.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,O.flipY),x.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),x.pixelStorei(N.UNPACK_ALIGNMENT,O.unpackAlignment);const Vn=x.getParameter(N.UNPACK_ROW_LENGTH),ut=x.getParameter(N.UNPACK_IMAGE_HEIGHT),ni=x.getParameter(N.UNPACK_SKIP_PIXELS),yi=x.getParameter(N.UNPACK_SKIP_ROWS),ar=x.getParameter(N.UNPACK_SKIP_IMAGES);x.pixelStorei(N.UNPACK_ROW_LENGTH,Nt.width),x.pixelStorei(N.UNPACK_IMAGE_HEIGHT,Nt.height),x.pixelStorei(N.UNPACK_SKIP_PIXELS,De),x.pixelStorei(N.UNPACK_SKIP_ROWS,$e),x.pixelStorei(N.UNPACK_SKIP_IMAGES,Ze);const us=S.isDataArrayTexture||S.isData3DTexture,St=O.isDataArrayTexture||O.isData3DTexture;if(S.isDepthTexture){const Vt=k.get(S),or=k.get(O),At=k.get(Vt.__renderTarget),lr=k.get(or.__renderTarget);x.bindFramebuffer(N.READ_FRAMEBUFFER,At.__webglFramebuffer),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,lr.__webglFramebuffer);for(let fs=0;fs<Ce;fs++)us&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,k.get(S).__webglTexture,V,Ze+fs),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,k.get(O).__webglTexture,xe,kt+fs)),N.blitFramebuffer(De,$e,ve,Se,Le,xt,ve,Se,N.DEPTH_BUFFER_BIT,N.NEAREST);x.bindFramebuffer(N.READ_FRAMEBUFFER,null),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(V!==0||S.isRenderTargetTexture||k.has(S)){const Vt=k.get(S),or=k.get(O);x.bindFramebuffer(N.READ_FRAMEBUFFER,W),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,F);for(let At=0;At<Ce;At++)us?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,Vt.__webglTexture,V,Ze+At):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,Vt.__webglTexture,V),St?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,or.__webglTexture,xe,kt+At):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,or.__webglTexture,xe),V!==0?N.blitFramebuffer(De,$e,ve,Se,Le,xt,ve,Se,N.COLOR_BUFFER_BIT,N.NEAREST):St?N.copyTexSubImage3D(Ee,xe,Le,xt,kt+At,De,$e,ve,Se):N.copyTexSubImage2D(Ee,xe,Le,xt,De,$e,ve,Se);x.bindFramebuffer(N.READ_FRAMEBUFFER,null),x.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else St?S.isDataTexture||S.isData3DTexture?N.texSubImage3D(Ee,xe,Le,xt,kt,ve,Se,Ce,Mt,fn,Nt.data):O.isCompressedArrayTexture?N.compressedTexSubImage3D(Ee,xe,Le,xt,kt,ve,Se,Ce,Mt,Nt.data):N.texSubImage3D(Ee,xe,Le,xt,kt,ve,Se,Ce,Mt,fn,Nt):S.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,xe,Le,xt,ve,Se,Mt,fn,Nt.data):S.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,xe,Le,xt,Nt.width,Nt.height,Mt,Nt.data):N.texSubImage2D(N.TEXTURE_2D,xe,Le,xt,ve,Se,Mt,fn,Nt);x.pixelStorei(N.UNPACK_ROW_LENGTH,Vn),x.pixelStorei(N.UNPACK_IMAGE_HEIGHT,ut),x.pixelStorei(N.UNPACK_SKIP_PIXELS,ni),x.pixelStorei(N.UNPACK_SKIP_ROWS,yi),x.pixelStorei(N.UNPACK_SKIP_IMAGES,ar),xe===0&&O.generateMipmaps&&N.generateMipmap(Ee),x.unbindTexture()},this.initRenderTarget=function(S){k.get(S).__webglFramebuffer===void 0&&K.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?K.setTextureCube(S,0):S.isData3DTexture?K.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?K.setTexture2DArray(S,0):K.setTexture2D(S,0),x.unbindTexture()},this.resetState=function(){G=0,U=0,$=null,x.reset(),_e.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Li}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=st._getDrawingBufferColorSpace(e),t.unpackColorSpace=st._getUnpackColorSpace()}}it.registerPlugin(tt);const wy=document.querySelector(".cursor-dot"),Ry=document.querySelector(".cursor-outline");window.addEventListener("mousemove",r=>{const e=r.clientX,t=r.clientY;it.to(wy,{x:e,y:t,duration:.1,ease:"power2.out"}),it.to(Ry,{x:e,y:t,duration:.4,ease:"power2.out"})});const Cy=document.querySelectorAll("[data-cursor-hover], a, button");Cy.forEach(r=>{r.addEventListener("mouseenter",()=>{document.body.classList.add("cursor-hover")}),r.addEventListener("mouseleave",()=>{document.body.classList.remove("cursor-hover")})});let En=new Aa,Sd=new pm({size:.55,color:889992,transparent:!0,opacity:.9,blending:jc});const yd=document.querySelector("#webgl-container");if(yd){let f=function(){requestAnimationFrame(f);const h=d.getElapsedTime();l.position.copy(En.position),En.rotation.y=Math.sin(h*.2)*.05,En.rotation.x=Math.sin(h*.1)*.05;const _=En.children[0];if(_&&_.geometry){const g=_.geometry.attributes.position.array,p=_.geometry.attributes.originalPosition.array,m=En.scale.x,y=En.scale.y;for(let w=0;w<g.length;w+=3){const M=p[w],b=p[w+1],A=p[w+2];let E=M,v=b,T=A;if(c){const C=M*m+En.position.x,D=b*y+En.position.y,L=C-c.x,H=D-c.y,W=Math.sqrt(L*L+H*H),F=25*m;if(W<F){const G=(F-W)/F;E+=L/W*G*16/m,v+=H/W*G*16/y,T+=G*18/m}}g[w]+=(E-g[w])*.1,g[w+1]+=(v-g[w+1])*.1,g[w+2]+=(T-g[w+2])*.1}_.geometry.attributes.position.needsUpdate=!0}t.render(r,e)};var Iy=f;const r=new l0,e=new li(45,window.innerWidth/window.innerHeight,1,1e3);e.position.z=150;const t=new Ay({canvas:yd,alpha:!0,antialias:!0});t.setSize(window.innerWidth,window.innerHeight),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),En.position.set(95,-84,-35),En.scale.set(2.47,2.47,2.47),En.rotation.set(.1,Math.PI*.1,0),r.add(En),it.timeline({scrollTrigger:{trigger:"#horizontal-scroll-trigger",start:"top bottom",end:"top top",scrub:1}}).to(Sd,{opacity:0,ease:"power1.inOut"}).to(En.position,{z:-100,ease:"power1.inOut"},0);const i=new C0,s=new ft,a=new io(300,300),o=new Df({visible:!1}),l=new zi(a,o);l.position.copy(En.position),r.add(l);let c=null;window.addEventListener("mousemove",h=>{s.x=h.clientX/window.innerWidth*2-1,s.y=-(h.clientY/window.innerHeight)*2+1,i.setFromCamera(s,e);const _=i.intersectObject(l);_.length>0?c=_[0].point:c=null});const u=new Image;u.src="/src/assets/world-map.svg",u.onload=()=>{const h=document.createElement("canvas"),_=h.getContext("2d"),g=320,p=176;h.width=g,h.height=p,_.drawImage(u,0,0,g,p);const m=_.getImageData(0,0,g,p).data,y=new Mi,w=[],M=[];for(let A=0;A<p;A++)for(let E=0;E<g;E++){const v=(A*g+E)*4;if(m[v+3]>128){const C=(E-g/2)*.75,D=-(A-p/2)*.75,L=(Math.random()-.5)*1.5;w.push(C,D,L),M.push(C,D,L)}}y.setAttribute("position",new vi(w,3)),y.setAttribute("originalPosition",new vi(M,3));const b=new x0(y,Sd);En.add(b)};const d=new P0;f(),window.addEventListener("resize",()=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight)})}const Py=it.timeline();Py.from(".massive-text",{y:100,opacity:0,duration:1.5,ease:"power4.out",stagger:.2}).from(".hero-wrapper > div:not(.hero-float-wrapper):not(.hero-stats)",{y:30,opacity:0,duration:1,ease:"power3.out"},"-=1").from(".hero-float-wrapper",{y:50,opacity:0,duration:1,ease:"power3.out",stagger:.2,onComplete:()=>{it.to(".hero-float-wrapper",{y:-10,duration:2.5,ease:"sine.inOut",yoyo:!0,repeat:-1,stagger:.5})}},"-=0.8").from(".hero-stats",{y:20,opacity:0,duration:1,ease:"power3.out",onComplete:()=>{document.querySelectorAll(".hero-stats .stat-value").forEach(e=>{const t=parseFloat(e.getAttribute("data-val")),n=e.getAttribute("data-prefix")||"",i=e.getAttribute("data-suffix")||"",s={val:0};it.to(s,{val:t,duration:2,ease:"power2.out",onUpdate:()=>{e.innerText=n+Math.floor(s.val)+i}})})}},"-=0.5");const Go=document.getElementById("horizontal-wrapper");if(Go){const r=Go.offsetWidth-window.innerWidth;it.timeline({scrollTrigger:{trigger:"#horizontal-scroll-trigger",pin:!0,scrub:1,end:()=>"+="+Go.offsetWidth,invalidateOnRefresh:!0}}).to(Go,{x:-r,ease:"none"})}const Ho=document.getElementById("xray-trigger"),ma=document.getElementById("xray-mask");Ho&&ma&&(Ho.addEventListener("mousemove",r=>{const e=Ho.getBoundingClientRect(),t=r.clientX-e.left,n=r.clientY-e.top;it.to(ma,{opacity:1,duration:.3}),it.to("#xray-overlay",{opacity:1,duration:.3}),ma.style.webkitMaskImage=`radial-gradient(circle at ${t}px ${n}px, black 0%, transparent 150px)`,ma.style.maskImage=`radial-gradient(circle at ${t}px ${n}px, black 0%, transparent 150px)`}),Ho.addEventListener("mouseleave",()=>{it.to(ma,{opacity:0,duration:.5}),it.to("#xray-overlay",{opacity:0,duration:.5})}));const Ed=document.getElementById("ledger-console");if(Ed){let e=function(t){r.forEach((n,i)=>{const s=document.querySelector(n.node),a=document.querySelector(n.card);if(s){const o=s.querySelector(".node-num"),l=s.querySelector(".node-label"),c=s.querySelector(".node-status");i===t?(it.to(s,{opacity:1,duration:.3}),it.to(o,{borderColor:"#00FF87",color:"#00FF87",scale:1.1,duration:.3}),l&&(l.style.color="#fff"),c&&(c.style.color="#00FF87",c.textContent="STATUS: ACTIVE"),a&&it.to(a,{opacity:1,scale:1.02,borderColor:"#00FF87",boxShadow:"0 30px 60px -15px rgba(0, 255, 135, 0.15)",duration:.4}),Ed.innerHTML=n.log):(it.to(o,{borderColor:"rgba(255,255,255,0.2)",color:"rgba(255,255,255,0.4)",scale:1,duration:.3}),l&&(l.style.color="rgba(255,255,255,0.4)"),c&&(c.style.color="rgba(255,255,255,0.3)",c.textContent=i<t?"STATUS: COMPLETED":"STATUS: PENDING"),a&&it.to(a,{opacity:.35,scale:.98,borderColor:"rgba(255,255,255,0.08)",boxShadow:"0 30px 60px -15px rgba(0,0,0,0.6)",duration:.4}))}})};var Uy=e;const r=[{node:"#timeline-node-1",card:"#t-card-1",log:"&gt; Plant Encoding Activated...<br>&gt; 2D DataMatrix etched: 0x89F2A1<br>&gt; Speed: 400 cartons/min"},{node:"#timeline-node-2",card:"#t-card-2",log:"&gt; Depot Aggregation Init...<br>&gt; Pallet mapping: 0x3B2C8D<br>&gt; Structure: Parent-Child"},{node:"#timeline-node-3",card:"#t-card-3",log:"&gt; Regional Transit Verification...<br>&gt; Depot custody transfer: 0x9A4F9E<br>&gt; Boundaries: Geofenced"},{node:"#timeline-node-4",card:"#t-card-4",log:"&gt; Retail Shelf Audit Success!<br>&gt; Cryptographic decrypt: 0x7C5D41<br>&gt; Result: 100% Authentic"}];e(0),r.forEach((t,n)=>{tt.create({trigger:t.card,start:"top 60%",end:"bottom 40%",onToggle:s=>{s.isActive&&e(n)}});const i=document.querySelector(t.node);i&&(i.style.cursor="pointer",i.addEventListener("click",()=>{const s=document.querySelector(t.card);s&&s.scrollIntoView({behavior:"smooth",block:"center"})}))})}const Td=it.utils.toArray(".kinetic-text");Td.length>0&&Td.forEach((r,e)=>{const t=e%2===0?1:-1;it.to(r,{x:300*t,ease:"none",scrollTrigger:{trigger:"#kinetic-results",start:"top bottom",end:"bottom top",scrub:1}})});const Dy=document.querySelectorAll(".nav-trigger"),Yi=document.getElementById("menu-overlay");let Wo=!1;if(Yi){const r=Yi.querySelectorAll("a"),e=Yi.querySelectorAll("#menu-links-list li");r.forEach(t=>{t.addEventListener("mouseenter",()=>{const n=t.closest("li");e.forEach(i=>{i===n?(i.style.opacity="1",i.querySelector(".font-display").style.color="var(--color-accent)"):(i.style.opacity="0.3",i.querySelector(".font-display").style.color="#fff")})}),t.addEventListener("mouseleave",()=>{e.forEach(n=>{n.style.opacity="1",n.querySelector(".font-display").style.color="#fff"})}),t.addEventListener("click",()=>{Wo=!1,Yi.style.pointerEvents="none",it.to(Yi,{opacity:0,duration:.4}),document.querySelector(".nav-trigger").innerText="Menu [=]",e.forEach(n=>{n.style.opacity="1",n.querySelector(".font-display").style.color="#fff"})})}),Dy.forEach(t=>{t.addEventListener("click",()=>{Wo=!Wo,Wo?(Yi.style.pointerEvents="auto",it.to(Yi,{opacity:1,duration:.4}),t.innerText="Close [X]"):(Yi.style.pointerEvents="none",it.to(Yi,{opacity:0,duration:.4}),t.innerText="Menu [=]")})})}const wc=document.querySelectorAll(".timeline-nav-item"),_a=document.getElementById("timeline-content"),Xo=[{title:"Plant Encoding",description:"Unique high-density 2D barcodes are laser-etched onto packaging at speeds up to 400 cartons/minute. Cryptographic hashes tie serials directly to batch logs.",metric:"400/MIN",compliance:"DSCSA READY"},{title:"Depot Aggregation",description:"Map child units to parent shippers, and parent shippers to pallets. Generate logical relationships at the packing line, stored securely on local nodes.",metric:"100% ACCURATE",compliance:"GS1 COMPLIANT"},{title:"Distributor Handshake",description:"Track logical custody transfers seamlessly. Scan cases upon shipping or delivery to verify chain of custody, geofencing route limits in real time.",metric:"< 1s VERIFY",compliance:"REST API SYNC"},{title:"Retailer Scan",description:"Direct validation at point of sale. Retailers scan packages to confirm authenticity before shelf stocking, automatically auditing logistics flow.",metric:"ZERO LATENCY",compliance:"SECURE LEDGER"}];wc.length>0&&_a&&wc.forEach((r,e)=>{r.addEventListener("click",()=>{wc.forEach(t=>{t.classList.remove("active"),t.style.color="rgba(255,255,255,0.4)",t.style.borderLeftColor="transparent"}),r.classList.add("active"),r.style.color="var(--color-accent)",r.style.borderLeftColor="var(--color-accent)",it.to(_a,{opacity:0,y:-10,duration:.2,onComplete:()=>{_a.innerHTML=`
