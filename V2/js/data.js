...
export const scanFeed = [
  { label: "Authenticity verified", meta: "Nashik, IN · 2s ago", color: "var(--se-teal-400)" },
  { label: "Batch #A2291 scanned", meta: "Rajkot, IN · 5s ago", color: "var(--se-violet-400)" },
  { label: "Loyalty payout · ₹450", meta: "Indore, IN · 9s ago", color: "var(--se-amber-400)" },
];

export const scanFeedPool = [
  { label: "Authenticity verified", meta: "Pune, IN · just now", color: "var(--se-teal-400)" },
  { label: "Retailer scan logged", meta: "Kanpur, IN · just now", color: "var(--se-violet-400)" },
  { label: "Loyalty payout · ₹900", meta: "Guntur, IN · just now", color: "var(--se-amber-400)" },
  { label: "Diversion alert cleared", meta: "Ludhiana, IN · just now", color: "var(--se-amber-400)" },
];
...
export const problems = [
  { num: "01", color: "var(--se-violet-400)", title: "Blind spots past the factory gate", body: "Once goods leave your plant, visibility drops. Distributors report what they want, not what's real — so you make decisions on stale data." },
  { num: "02", color: "var(--se-amber-400)", title: "Counterfeits quietly drain your margin", body: "Fake products damage your brand, harm your consumers, and bleed revenue — often long before you know it's happening." },
  { num: "03", color: "var(--se-teal-400)", title: "Retailers have no reason to push you", body: "Your team visits once a month; a competitor's loyalty program runs every day. Without engagement, the shelf goes to whoever paid last." },
];
